...
The TSP package [@TSP:Hahsler+Hornik2007] provides the 
...
* State-of-the-art solver
  * An interface to the __Concorde TSP solver__ [@Applegate2000; @Applegate2006] and its implementation of 
  the __Chained-Lin-Kernighan heuristic__ [@Applegate2003] is provided (needs to be installed separately). 
